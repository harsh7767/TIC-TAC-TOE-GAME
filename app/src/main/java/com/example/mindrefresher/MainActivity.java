package com.example.mindrefresher;
...
public class MainActivity<i, oCount> extends AppCompatActivity {
...
oCount=0;
    ...
    {if((b1==1) && (b2==1) && (b3==1)){
        ...
        builder.setMessage("PlayerX Won").setCancelable(false).setPositiveButton("ok", new DialogInterface.OnClickListener() {
            @Override
        ...
        scorex.setText("Score X: "+String.valueOf(xCount));
            ...
            AlertDialog.Builder builder =new AlertDialog.Builder(this);
            builder.setMessage("PlayerO Won").setCancelable(false).setPositiveButton("ok", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface  dialog, int i) {
